...
export default function MusicArtwork({
  ...
  const sizeClass = size ? undefined : "w-48 h-48 sm:w-64 sm:h-64";
    ...
    return (
      <div className="relative">
        <div className="relative group">
          <div className={`${sizeClass || ''} bg-neutral-200 dark:bg-neutral-800 rounded-lg animate-pulse`} style={sizeStyle} />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="relative">
      ...
      <div className="relative group">
        ...
        <div
          className={`relative overflow-hidden rounded-lg shadow-2xl transition-all duration-300 ease-out hover:scale-105 hover:shadow-3xl cursor-pointer ${sizeClass || ''}`}
          style={sizeStyle}
